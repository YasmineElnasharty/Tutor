...
const icon: string[] = ["fa fa-facebook", "fa fa-instagram", "fa fa-youtube", "fa fa-whatsapp"]
         ...
         <div className="container">
            <div className="team-details-page">
               ...
               <div className="details-inner mt-4 pt-xl-3">
                  <span>Waltz, bad nymph, for quick jigs vex! Fox nymphs grab quick-jived waltz. Brick quiz whangs jumpy veldt</span>
                  <p className="mt-3">At Home Town Tutor, we believe that success is a collective effort. Our approach harnesses the power of collaborative learning and community support to help students achieve their highest potential. veldt fox. Bright vixens jump; dozy fowl quack. Quick wafting zephyrs vex bold Jim. Quick zephyrs blow, vexing daft Jim. Sex-charged fop blew </p>
               </div>
            </div>
