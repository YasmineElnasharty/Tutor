...
const intro_data: DataType[] = [
   {
      ...
      page: "home_1",
      icon: icon_1,
      title: "Step 1: Assess Your Needs",
      desc: "Tell us about your academic challenges and goals. We tailor our tutoring to meet your unique needs."
   },
   {
      id: 2,
      page: "home_1",
      icon: icon_2,
      title: "Step 2: Try Our Free Trials",
      desc: "Experience our tutoring services with a free trial session. See how we can help you succeed."
   },
   {
      id: 3,
      page: "home_1",
      ...
      desc: "Choose the tutoring package that best fits your needs and schedule. We offer flexible options."
   },
   {
      id: 4,
      page: "home_1",
